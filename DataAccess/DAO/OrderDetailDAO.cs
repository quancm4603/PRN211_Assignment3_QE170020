...
namespace DataAccess.DAO
{
    public class OrderDetailDAO
    {
        ...
        //FindOrderDetailsByOrderId(int orderId);
        public IEnumerable<OrderDetail> FindOrderDetailsByOrderId(int orderId)
        {
            IEnumerable<OrderDetail> orderDetails = new List<OrderDetail>();
            try
            {
                var context = new SalesManagementContext();
                orderDetails = context.OrderDetails.Where(o => o.OrderId == orderId);
            } catch (Exception ex)
            {
                throw new Exception(ex.Message);
            }
